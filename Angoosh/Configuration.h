...
#define STRING_CONFIG_H_AUTHOR "Satan" // Who made the changes.
...
#define HOMING_FEEDRATE {50*60, 50*60, 160, 0}  // set the homing speeds (mm/min)

// default settings

#define DEFAULT_AXIS_STEPS_PER_UNIT   {106.67,106.67,1066.67,(200*16)*(7.2*3.14159)}  // default steps per unit for Ultimaker
